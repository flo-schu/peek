...
bnds=optimize.Bounds(lb=[0,0,0,0,15,1e-5], ub=[100,100,100,100,100,100])
...
ax1.plot(dfpp[temp[1]], linestyle="dotted" , color="orange", label=temp[1])
ax1.plot(dfpp[temp[0]], linestyle="dotted", color ="blue", label=temp[0])
ax1.set_xscale('log')
ax1.legend()
ax1.set_xlabel("pesticide concentration")
...
ax2.plot( dfp[:,pest[1]], linestyle="dashed", color ="green",  label=np.round(pest[1],1))
ax2.plot(dfpp[:,pest[1]], linestyle="dotted", color ="green")
ax2.plot( dfp[:,pest[3]], linestyle="dashed", color ="red",    label=np.round(pest[3],1))
ax2.plot(dfpp[:,pest[3]], linestyle="dotted", color ="red")
ax2.plot( dfp[:,pest[4]], linestyle="dashed" , color="orange", label=np.round(pest[4],1))
ax2.plot(dfpp[:,pest[4]], linestyle="dotted" , color="orange")
ax2.legend()
ax2.set_xlabel("temperature increase")
