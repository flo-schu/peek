...
plt.plot(absorption[nut], est, "o", color="black", alpha=.5)
plt.plot(absorption[nut], concentration[nut], 'go', alpha=.1)
plt.xlabel("Absorption")
plt.ylabel("Concentration [mg L-1]")
...
est = estimate_concentration(absorption[nut], concentration[nut])
plt.plot(absorption[nut], est, "o", color="black", alpha=.5)
plt.plot(absorption[nut], concentration[nut], 'go', alpha=.5)
plt.xlabel("Absorption")
plt.ylabel("Concentration [mg L-1]")
